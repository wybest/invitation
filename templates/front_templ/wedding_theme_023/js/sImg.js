;(function($){$.fn.sImg=function(o,cb){this.each(function(){var th=$(this),data=th.data('sImg'),_={duration:1000,sleep:300,spinner:'<span class="spinner"></span>',preFu:function(){_.me.css('position')=='static'&&_.me.css({position:'relative',zIndex:1})},chngFu:function(src){if(src==_.src)
return false
_.src=src
...
if(typeof _.spinner=='object'){if(_.spinner.parent&&_.spinner.parent().length==0)
