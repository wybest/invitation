;(function($){$.fn.uCarousel=function(o){return this.each(function(){var th=$(this),_=th.data('uCarousel')||{axis:'x',show:3,step:1,rows:1,curr:0,shift:0,itms:[],clickable:false,retFalse:true,pageStep:3,duration:1000,easing:'swing',activeClass:'active',buttonClass:'+.carousel-btns a',blockAtEnd:true,fu:{pre:function(){_.axis=_.axis=='x'
_.ul=$('>ul',_.me)
...
_.fu.move(_.fu.calc(n))},move:function(pos){_.ul.stop().animate(pos,{duration:_.duration,easing:_.easing})},buttons:function(){var btns=$(_.buttonClass,_.me)
if(!btns.length)
btns=$(_.buttonClass,_.me)
btns.each(function(){var th=$(this),type=th.data('type')
...
_.fu.buttons()
_.fu.clickable()}}
swtch(typeof o,{object:function(){$.extend(true,_,o)},string:function(){swtch(o,{next:function(){_.fu.next()},prev:function(){_.fu.prev()},nextPage:function(){_.fu.nextPage()},prevPage:function(){_.fu.prevPage()},"default":function(){}})()},number:function(){th.states(o)},"function":function(){_.me.on('_change',function(){o(_.n,_)})},"default":function(){}})()
