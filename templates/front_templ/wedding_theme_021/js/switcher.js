;(function($){$.fn.navs=function(o){this.each(function(){var th=$(this),data=th.data('navs'),_={enable:true,actCl:'active',items:'>ul>li',changeEv:'change',indx:[],hshx:[],useHash:false,defHash:'#!/',emptyHash:'#',outerHash:false,autoPlay:false,blockSame:true,hover:true,contRetFalse:true,preFu:function(){_.li.each(function(n){var th=$(this)
_.indx[n]=th
...
location.hash=_.defHash},backFu:function(){_.chngFu(_.pren==-1||_.pren==void 0?_.def:_.pren)},nextFu:function(){var n=_.n
_.chngFu(++n<_.li.length?n:0)},prevFu:function(){var n=_.n
_.chngFu(--n>=0?n:_.li.length-1)},customStr:function(str){},init:function(){_.li=$(_.items,_.me)
_.preFu()
_.rfrshFu()
_.markFu()
