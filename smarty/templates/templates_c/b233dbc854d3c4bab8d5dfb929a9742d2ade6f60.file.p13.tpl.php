...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20801529499f9653ef2-85797581',
  'function' => 
  array (
  ),
...
<div class="extra">
  ...
  <div class="main"> 
    <!--header -->
    <header>
      <h1><a href="#!/page_about" id="logo"><?php echo $_smarty_tpl->tpl_vars['show_time']->value;?>
  ...
  <?php echo $_smarty_tpl->tpl_vars['bigtitle']->value;?>
      ...
      <nav class="menu">
        <ul id="menu">
          ...
          <li><a href="#!/page_menu" class="ex-1"><span class="mText"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</span></a></li>
        ...
        <li id="page_about" class="contentPad">
          <div class="wrapper">
            <section class="patternPad">
              <article>
                <h2>真诚的邀请</h2>
                <h3 style="font-size:20px;"><?php echo $_smarty_tpl->tpl_vars['show_time']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['mini_time']->value;?>
</h3>
...
?>
			       <li style="float:left;width:260px;"><a href="http://bcs.duapp.com/marryimg/<?php echo $_smarty_tpl->tpl_vars['images']->value[$_smarty_tpl->getVariable('smarty')->value['section']['customer']['index']];?>
...
"  style="max-width:248px;max-height:309px" /></a></li>
			  <?php endfor; endif; ?>
								              </ul>
              <div class="zigzagPad"></div>
            </section>
