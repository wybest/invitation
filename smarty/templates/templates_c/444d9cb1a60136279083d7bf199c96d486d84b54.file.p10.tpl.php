<?php /* Smarty version Smarty-3.1.13, created on 2013-11-28 10:42:56
         compiled from "smarty\templates\templates\pc\p10.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1204752935b4a599fb1-85377146%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '444d9cb1a60136279083d7bf199c96d486d84b54' => 
    array (
      0 => 'smarty\\templates\\templates\\pc\\p10.tpl',
      1 => 1385473236,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1204752935b4a599fb1-85377146',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_52935b4a6b8fd1_31986708',
  'variables' => 
  array (
    'bigtitle' => 0,
    'title' => 0,
...
<?php if ($_valid && !is_callable('content_52935b4a6b8fd1_31986708')) {function content_52935b4a6b8fd1_31986708($_smarty_tpl) {?>﻿<!DOCTYPE html>
<html lang="en">
<head>
			...
			<header>
				<nav class="menu">
					<ul id="menu">
                        ...
                        <li><span class="nav5"></span><a href="#!/page_Events"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</a></li>
				...
				<ul>
					<li id="page_About">
						...
						<div class="right_box">
							...
							<div class="block">
								<h2><?php echo $_smarty_tpl->tpl_vars['show_time']->value;?>
...
"  class="img<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['customer']['iteration'];?>
" style="max-width:466px;max-height:670px;" />
							 <?php endfor; endif; ?>
...
?>
									      ...
									      <?php if ($_smarty_tpl->getVariable('smarty')->value['section']['customer']['iteration']%2==0){?>
										    	<div class="col1">
													<figure class="gallery_img" style="padding-top:0px;"><a href="#img<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['customer']['iteration'];?>
"><img src="http://bcs.duapp.com/marryimg/<?php echo $_smarty_tpl->tpl_vars['images']->value[$_smarty_tpl->getVariable('smarty')->value['section']['customer']['index']];?>
" alt="" style="width:155px;height:220px"><span></span></a></figure>
												</div>
												</div>
											...
											<div class="col1 marg_right1">
												<figure class="gallery_img" style="padding-top:0px;"><a href="#img<?php echo $_smarty_tpl->getVariable('smarty')->value['section']['customer']['iteration'];?>
"><img src="http://bcs.duapp.com/marryimg/<?php echo $_smarty_tpl->tpl_vars['images']->value[$_smarty_tpl->getVariable('smarty')->value['section']['customer']['index']];?>
" alt="" style="max-width:155px;max-height:220px"><span></span></a></figure>
											</div>
										    <?php }?>
					...
					<li id="page_Contacts">
						...
						<div class="right_box">
							...
							<div class="block">
								...
								<p style="margin-top:30px;">婚礼地点：<?php echo $_smarty_tpl->tpl_vars['adress']->value;?>
</p>
							</div>
						</div>
					</li>
				...
				<h1><a href="#!/page_About" id="logo"><?php echo $_smarty_tpl->tpl_vars['bigtitle']->value;?>
 </a></h1>
			</article>
			<!--content end-->
		</div>
