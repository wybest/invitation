...
<div id="jQUi">
    ...
    <div id="content">
        <div id="main" class="panel" selected="true" data-load="loadedPanel" data-unload="unloadedPanel" data-tab="navbar_home"  style="z-index:99999">
            <div class="wedbox">
                <a class="meetus" href="#first">&lt;&lt;打开喜帖</a> </div>
        </div>
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    <ul class="wednav">
                        ...
                        <li><a href="showimgs.php?user={#$name#}" data-persist-ajax="true" data-refresh-ajax="true" title="_" data-pull-scroller="true"><img src="style/style12/wednav2.png" alt="{#$title2#}"><br>
...
<script type="text/javascript" src="style/style12/video.js"></script>
...
<script src="style/style12/weixin_share.js"></script>
<script>
    var contentModel = {
