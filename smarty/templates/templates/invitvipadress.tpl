...
<a target="_blank" href="http://{#$host#}pc.php?name={#$user_id#}@{#$vip_array[customer]->id#}"><img src='http://chart.apis.google.com/chart?cht=qr&chs=150x150&choe=UTF-8&chld=L|4&chl={#$adress#}{#$vip_array[customer]->id#}' width='130' height='130'  /></a>
</div>	
