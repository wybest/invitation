...
//alert(getMainPanelText());
    $("#invite_style").change(function() {
        ...
        if($("#invite_style option:selected").val() == "phone2" ||
            ...
            $('#iframepage').attr('src','new_temp_phone.php?tpl=phone');
        }
    });
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1">
                ...
                <tr>
                    ...
                    <td colspan="2" valign="top">
                        ...
                        <input readOnly="true" type="text" id="music" name="music" value="{#if $music #}{#$music#}{#else#}couldThisBeLove.mp3{#/if#}" size="25">
...
<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all ui-sortable">
    ...
    <li style="width: 15.5%;" id="7042" class="ui-state-default ui-corner-top"><a id="invite_detail_title7042" href="#invite_detail_content7042">

            <input class="tab_name tab_name_idle" type="text" id="invite_detail_name7042" name="title1" value="{#if $title1#}{#$title1#}{#else#}爱的邀约{#/if#}" size="6">
        </a></li>
    <script>
    ...
    <li style="width: 15.5%;" id="7041" class="ui-state-default ui-corner-top"><a id="invite_detail_title7041" href="#invite_detail_content7041">

            <input class="tab_name tab_name_idle" type="text" id="invite_detail_name7041" name="title2" value="{#if $title2#}{#$title2#}{#else#}婚纱相册{#/if#}" size="6">
        </a></li>
    <script>
    ...
    <li style="width: 15.5%;" id="7043" class="ui-state-default ui-corner-top"><a id="invite_detail_title7043" href="#invite_detail_content7043">
            ...
            <input class="tab_name tab_name_idle" type="text" id="invite_detail_name7043" name="title3" value="{#if $title3#}{#$title3#}{#else#}婚宴回函{#/if#}" size="6">
        </a></li>
    <script>
    ...
    <li style="width: 15.5%;" id="7044" class="ui-state-default ui-corner-top"><a id="invite_detail_title7044" href="#invite_detail_content7044">

            <input class="tab_name tab_name_idle" type="text" id="invite_detail_name7044" name="title4" value="{#if $title4#}{#$title4#}{#else#}婚宴地图{#/if#}" size="6">
        </a></li>
    <script>
    ...
    <li style="width: 15.5%;" id="7046" class="ui-state-default ui-corner-top"><a id="invite_detail_title7046" href="#invite_detail_content7046">

            <input class="tab_name tab_name_idle" type="text" id="invite_detail_name7046" name="title" value="{#if $title#}{#$title#}{#else#}爱情故事{#/if#}" size="6">
        </a></li>
    <script>
    ...
    <li style="width: 15.5%;" id="7045" class="ui-state-default ui-corner-top"><a id="invite_detail_title7045" href="#invite_detail_content7045">

            <input class="tab_name tab_name_idle" type="text" id="invite_detail_name7045" name="title5" value="{#if $title5#}{#$title5#}{#else#}婚礼提醒{#/if#}" size="6">
        </a></li>
    <script>
