...
window.location.href="xiangdao.html" ; 
} 
                    ...
                    <div id="main-title">
                        ...
                        <div class="main-title-mr"><div class="main-title-ml">
                            ...
                            <div class="main-title-mm">
                                <div id="maintitlehtml"><span style="text-decoration: none; font-style: normal; font-size: 20px; font-weight: normal; ">{#$vip#}{#$bigtitle#}</span></div>
                            </div>
...
<!-- 大圖 -->  
                            <img id="invite_webimg" src="uploadimg/{#$bigimage #}" width="100%" alt="Mobile Wedding Invitations">
...
{#section name=customer loop=$images #}
	<li><a href="uploadimg/{#$images[customer]#}" rel="external"><img src="uploadimg/{#$images[customer]#}" alt=" "/></a></li>
{#/section#}
...
function FormCheck()
{
	...
	var zf = $('#zf').val();
	var pnum = $('#pnum').val();
	var go_is = $('#is_go_0').attr('checked');
	var go_not = $('#is_go_1').attr('checked');
	if(name == ''){
		alert('请填写姓名');
		return;
	}
	...
	$.post('save_shuju.php', {user:username, name:encodeURIComponent(name), zf:encodeURIComponent(zf), isgo:encodeURIComponent(isgo),pnum:pnum}, function (data){
...
:            </td>
          ...
          <tr>
            <td><p>
                <label>　
                  <input type="radio" name="is_go" value="是" id="is_go_0" checked="checked"/>
                非常乐意，有<select id="pnum" name="pnum"><option value="">请选择</option>
                ...
                <option value="9">9</option></select>人参加</label>
                <br />
                <label>
                  　
                    <input type="radio" name="is_go" value="否" id="is_go_1"  />
                 无法参加</label>
                <br />
            </p></td>
          </tr>
          ...
          <tr>
            <td>　
              <label for="zf"></label>
            <textarea name="zf" rows="5" id="zf"></textarea></td>
          </tr>
          <tr>
            <td>
                                     <span id="bi_msg"></span>　　　　　
              <input type="button" name="button" id="button" value="发送" onClick="javascript:return FormCheck();" />
            </td>
          </tr>
        </table>
...
<audio autoplay="autoplay" id="audio_play" loop="loop">
				  ...
				  <source src="http://{#$host#}mp3/{#$music#}" type="audio/mpeg">
                </audio>
<script type="text/javascript">
    var share_img_url = "http://{#$host#}jpg/{#$bigimage#}";
