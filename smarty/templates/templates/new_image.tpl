...
{#/if#} 
<div class="alert alert-success">（建议6张相片最合适,相片要求为竖版 500*750）相片大小限制在200kb内，手机打开是很清晰的，打开速度会很快,压缩图片去<a target="_blank" href="http://xiuxiu.web.meitu.com/">美图秀秀网页版</a> </div>
<div style="">
