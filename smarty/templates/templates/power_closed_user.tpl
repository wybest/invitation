...
<ul class="pager">
    <li class="previous"><a href="power_closed_user.php?page_nm=1">第一页</a></li>
    <li class="previous"><a href="power_closed_user.php?page_nm={#$up#}">&larr;前一页</a></li>
    <li class="next"><a href="power_closed_user.php?page_nm={#$end#}">最后一页</a></li>
    <li class="next"><a href="power_closed_user.php?page_nm={#$next#}">下一页&rarr;</a></li>
