...
<div id="loaddiv" class="content clearfix">
  ...
  <div class="login_form clearfix">
    ...
    <div class="pad_50 clearfix">
      ...
      <form action="power.php" id="form1" method="post">
	...
	<input name="tobind" type="hidden" id="tobind" value="0">
        ...
        <div class="input-field clearfix" id="loginId">
          ...
          <input type="text" name="aname" value="" id="aname" class="input_kuang item errortip" placeholder="管理员账号" isRequired="true"  autocomplete="off"/>

        </div>

        <div class="input-field clearfix" id="loginPass">

          <input type="password" name="apassword" class="input_kuang item errortip" id="apassword" placeholder="管理员密码" isRequired="true" autocomplete="off"/>
        ...
        <div class="sub_log clearfix">
          ...
          <div class="sub_login flt_l"><input type="submit" class="no_bg" value="登录后台"/></div>
