...
<div id="x_menus">
	<table cellspacing="0">
		<tbody><tr>
            <th width="20%" class=" cur"><a class="sy" href="#">封面</a></th>
            <th width="20%" class=""><a class="qj" href="#">请柬</a></th>
            <th width="20%" class=""><a class="zp" href="#">相册</a></th>
            <th width="20%" class=""><a class="dt" href="#">地图</a></th>
            <th width="20%" class=""><a class="zf" href="#">祝福</a></th>
		</tr>
	</tbody></table>
</div>
<script type="text/javascript">
