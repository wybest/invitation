...
<!--SPLIT--><div class="body">
	<div id="cover" class="cover">
		<div id="main_bg">	<img src="style/style26/face_cover.png" alt="bg"></div>
		<div id="cover_img"><img src="marryimg/{#$bigimage#}" id="banner_img" alt="新婚幸福"></div></div>
	</div>
...
<div id="menu_main" class="menu_main" style="display: none;">
    <a class="mix" href="javascript:getHtml('phone2.php?style=style26&target=home&name={#$name#}@{#$vip_id#}')">返回封面</a>
    <a class="mqj" href="javascript:getHtml('phone2.php?style=style26&target=invite&name={#$name#}@{#$vip_id#}')">电子请柬</a>
    <a class="mzp" href="javascript:getHtml('phone2.php?style=style26&target=photo&name={#$name#}@{#$vip_id#}')">婚纱照片</a>
    <a class="mdt" href="javascript:getHtml('phone2.php?style=style26&target=map&name={#$name#}@{#$vip_id#}')">电子地图</a>
    <a class="mzf" href="javascript:getHtml('phone2.php?style=style26&target=words&name={#$name#}@{#$vip_id#}')">新婚祝福</a>
</div>
<script type="text/javascript">
