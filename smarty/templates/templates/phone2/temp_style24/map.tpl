...
<body id="color_a">
<div id="myHtmlArea">
<!--SPLIT--><div style="margin:8px;border-radius:5px;-webkit-border-radius:5px;min-height:0;overflow:hidden">
        ...
        <tr>
            ...
            <div class="mcon">
                ...
                <div id="group2" style="display:none;">
                    <a href="javascript:getHtml('phone2.php?style=style1&target=home&name={#$name#}@{#$vip_id#}')">返回封面</a>
                    <a class="s" href="javascript:getHtml('phone2.php?style=style1&target=invite&name={#$name#}@{#$vip_id#}')">电子请柬</a>
                    <a href="javascript:getHtml('phone2.php?style=style1&target=photo&name={#$name#}@{#$vip_id#}')">婚纱照片</a>
                    <a class="s" href="javascript:getHtml('phone2.php?style=style1&target=map&name={#$name#}@{#$vip_id#}')">电子地图</a>
                    <a href="javascript:getHtml('phone2.php?style=style1&target=words&name={#$name#}@{#$vip_id#}')">祝福留言</a>
                </div>
            </div>
            </td>
        </tr>
