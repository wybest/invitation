...
<!--SPLIT--><div class="body">
    ...
    <table width="100%">
        <tbody><tr>
            <td align="center">
                <a class="mqj" href="javascript:getHtml('phone2.php?style=style24&target=invite&name={#$name#}@{#$vip_id#}')"></a>
                <span>请柬</span>
            </td>
            <td align="center">
                <a class="mzp" href="javascript:getHtml('phone2.php?style=style24&target=photo&name={#$name#}@{#$vip_id#}')"></a>
                <span>照片</span>
            </td>
            <td align="center">
                <a class="mdt" href="javascript:getHtml('phone2.php?style=style24&target=map&name={#$name#}@{#$vip_id#}')"></a>
                <span>地图</span>
            </td>
            <td align="center">
                <a class="mzf" href="javascript:getHtml('phone2.php?style=style24&target=words&name={#$name#}@{#$vip_id#}')"></a>
                <span>祝福</span>
            </td>
        </tr>
    </tbody></table>
