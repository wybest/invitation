...
<div id="myHtmlArea"><!--SPLIT--><div class="body">
   <div id="cover" class="cover" style="border-color:#fff;"><table cellpadding="0" cellspacing="0"><tbody><tr><th><img src="marryimg/{#$bigimage#}" id="banner_img" alt="新婚幸福"></th></tr></tbody></table></div>
   <div class="mtf mtf_zp">
       <table width="100%" cellspacing="10" class="headtit">
           <tbody><tr>
               <td align="right">婚纱</td>
               <td width="230"></td>
               <td align="left">照片</td>
           </tr>
       </tbody></table>
       <table width="100%" class="head">
           <tbody><tr>
               ...
               <td width="100" align="center"><img src="style/style27/rose.png" alt="rose"></td>
