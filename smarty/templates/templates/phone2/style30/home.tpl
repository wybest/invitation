...
<body id="color_b">
<div id="myHtmlArea">
<!--SPLIT--><div class="body" id="index_area">
		...
		<tr>
		<td><img src="style/style30/word_img.png" ></td>
		</tr>
		</tbody></table>
		<div class="hr_line_c"></div>
	<div id="cover" class="cover">
		<div id="cover_img"><img src="marryimg/{#$bigimage#}" id="banner_img" ></div></div>
	</div>
	<div id="come_in_btn"></div>
</div>
<!--SPLIT-->
