...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <link rel="stylesheet" type="text/css" href="style/style30/eic.css">
	<script type="text/javascript" src="style/style30/j.js"></script>
    <link rel="stylesheet" href="style/style24/discuz.css"><style type="text/css" charset="utf-8">/* See license.txt for terms of usage */
/** reset styling **/
.firebugResetStyles {
	...
	<div class="line">
	   <div class="mtf mtf_qj">
		   ...
		   <table class="head" width="100%">
			   ...
			   <tr>
				<td><img src="style/style30/word_img.png" alt="欢迎您"></td>
			   </tr>
		   </tbody></table>
			<div class="hr_line_c"></div>
		   <div class="infos">
			   <p class="etime">{#$show_time#}</p>
			   <div><img src="style/style30/word_img_1.jpg" alt="举行结婚典礼"></div>
...
<script type="text/javascript" src="style/style30/lhgdialog.js"></script>
<script type="text/javascript" src="style/style30/mobile_eic_01.js"></script>
<div id="menus_area_this">
<div id="x_menus">
	<table cellspacing="0">
		<tbody><tr>
            <th width="20%" class=" cur"><a class="sy" href="javascript:getHtml('phone2.php?style=style30&target=home&name={#$name#}@{#$vip_id#}')">封面</a></th>
            <th width="20%" class=""><a class="qj" href="javascript:getHtml('phone2.php?style=style30&target=invite&name={#$name#}@{#$vip_id#}')">请柬</a></th>
            <th width="20%" class=""><a class="zp" href="javascript:getHtml('phone2.php?style=style30&target=photo&name={#$name#}@{#$vip_id#}')">相册</a></th>
            <th width="20%" class=""><a class="dt" href="javascript:getHtml('phone2.php?style=style30&target=map&name={#$name#}@{#$vip_id#}')">地图</a></th>
            <th width="20%" class=""><a class="zf" href="javascript:getHtml('phone2.php?style=style30&target=words&name={#$name#}@{#$vip_id#}')">祝福</a></th>
		</tr>
	</tbody></table>
</div>
<script type="text/javascript">
...
<link href="style/style30/photoswipe.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="style/style30/klass.min.js"></script>
<script type="text/javascript" src="style/style30/code.photoswipe.jquery-3.0.4.min.js"></script>
<script src="style/style30/api" type="text/javascript"></script><script type="text/javascript" src="style/style30/getscript"></script><link rel="stylesheet" type="text/css" href="style/style30/bmap.css">
<script type="text/javascript">
    function phote_func(){
