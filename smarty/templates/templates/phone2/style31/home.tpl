...
<!--SPLIT--><div id="mask_bg"></div><div class="body" id="index">
    <table width="100%" height="100%" cellspacing="10">
        <tbody><tr>
            <td class="cover" colspan="2"><img src="marryimg/{#$bigimage#}" alt="请柬封面" id="banner_img"></td>
        </tr>
        <tr valign="middle">
            <td align="center" class="qj_con"><a href="javascript:getHtml('/m4315/invite.html')" class="mbtn bqj">&nbsp;</a></td>
            <td align="center" class="zp_con"><a href="javascript:getHtml('/m4315/photo.html')" class="mbtn bzp">&nbsp;</a></td>
        </tr>
        <tr valign="middle">
            <td align="center" class="dt_con"><a href="javascript:getHtml('/m4315/map.html')" class="mbtn bdt">&nbsp;</a></td>
            <td align="center" class="zf_con"><a href="javascript:getHtml('/m4315/words.html')" class="mbtn bzf">&nbsp;</a></td>
        </tr>
    </tbody></table>
</div>
<!--SPLIT-->
...
<style type="text/css">
    #musicControl { position:fixed;top:50%;margin-top:-27px;display:inline-block;z-index:99999999}
...
<div class="side" id="side" style="right: -40px;">
    <a class="sy cur" href="javascript:getHtml('phone2.php?style=style31&target=home&name={#$name#}@{#$vip_id#}')"></a>
    <a class="qj" href="javascript:getHtml('phone2.php?style=style31&target=invite&name={#$name#}@{#$vip_id#}')"></a>
    <a class="zp" href="javascript:getHtml('phone2.php?style=style31&target=photo&name={#$name#}@{#$vip_id#}')"></a>
    <a class="dt" href="javascript:getHtml('phone2.php?style=style31&target=map&name={#$name#}@{#$vip_id#}')"></a>
    <a class="zf" href="javascript:getHtml('phone2.php?style=style31&target=words&name={#$name#}@{#$vip_id#}')"></a>
</div>
